...
public class AssignmentDetailActivity extends Activity {
    @BindView(R.id.assignment_detail_title)
    TextView assignment_detail_title;

    @BindView(R.id.featuredImageView)
    ImageView featured_image;

    @BindView(R.id.assignment_detail_deadline)
    TextView assignment_detail_deadline;

    @BindView(R.id.assignment_detail_text)
    TextView assignment_detail_text;

    @BindView(R.id.assignment_detail_location)
    TextView assignment_detail_location;

    @BindView(R.id.assignment_detail_author)
    TextView assignment_detail_author;
    ...
    @OnClick(R.id.start_reporting_button)
    public void start_reporting() {
